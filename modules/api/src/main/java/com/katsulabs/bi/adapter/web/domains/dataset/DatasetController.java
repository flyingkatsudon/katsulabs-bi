...
import com.katsulabs.bi.application.domains.dataset.DatasetWriteCommand;
...
public class DatasetController {
    ...
    private static DatasetResponse toDetailResponse(DatasetDetail detail) {
        ...
        if (detail.dataJson() != null) {
            try {
                var root = com.katsulabs.bi.application.common.JsonMapper.mapper().readTree(detail.dataJson());
