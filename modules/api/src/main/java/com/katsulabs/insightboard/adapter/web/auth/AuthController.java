...
import com.katsulabs.insightboard.application.auth.LoginCommand;
import com.katsulabs.insightboard.application.auth.LoginUseCase;
import com.katsulabs.insightboard.security.InsightBoardUserPrincipal;
...
public class AuthController {
    ...
    public LoginResponse login(@Valid @RequestBody LoginRequest request, HttpServletRequest httpRequest) {
        ...
        var principal = new InsightBoardUserPrincipal(user);
