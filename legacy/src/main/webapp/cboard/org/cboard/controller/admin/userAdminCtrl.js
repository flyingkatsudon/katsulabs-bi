...
cBoard.controller('userAdminCtrl', function ($scope, $http, ModalUtils, $filter) {
    ...
    $http.get("/bdp/cboard/admin/isAdmin").success(function (response) {
        $scope.isAdmin = response;
    });

    var getUserList = function () {
        $http.get("/bdp/cboard/admin/getUserList").success(function (response) {
    ...
    var getRoleList = function () {
        $http.get("/bdp/cboard/admin/getRoleList").success(function (response) {
    ...
    var getUserRoleList = function () {
        $http.get("/bdp/cboard/admin/getUserRoleList").success(function (response) {
    ...
    var getBoardList = function () {
        return $http.get("/bdp/cboard/admin/getBoardList").success(function (response) {
    ...
    var getMenuList = function () {
        return $http.get("/bdp/cboard/admin/getMenuList").success(function (response) {
    ...
    var getDatasourceList = function () {
        return $http.get("/bdp/cboard/admin/getDatasourceList").success(function (response) {
    ...
    var getDatasetList = function () {
        return $http.get("/bdp/cboard/admin/getDatasetList").success(function (response) {
    ...
    var getWidgetList = function () {
        return $http.get("/bdp/cboard/admin/getWidgetList").success(function (response) {
    ...
    var getJobList = function () {
        return $http.get("/bdp/cboard/admin/getJobList").success(function (response) {
    ...
    var getRoleResList = function () {
        $http.get("/bdp/cboard/admin/getRoleResList").success(function (response) {
    ...
    $scope.saveUser = function () {
        ...
        if ($scope.optFlag == 'newUser') {
            $http.post("/bdp/cboard/admin/saveNewUser", {user: angular.toJson($scope.curUser)}).success(function (serviceStatus) {
                if (serviceStatus == '1') {
                    $scope.optFlag = 'none';
                    getUserList();
                ...
                // user를 추가한 후에 role refresh
                getRoleList();
            });
        } else {
            $http.post("/bdp/cboard/admin/updateUser", {user: angular.toJson($scope.curUser)}).success(function (serviceStatus) {
                if (serviceStatus == '1') {
                    $scope.optFlag = 'none';
                    getUserList();
                    $scope.verify = {dsName: true};
    ...
    $scope.grantRole = function () {
        ...
        $http.post("/bdp/cboard/admin/updateUserRole", {
    ...
    $scope.revokeRole = function () {
        ...
        $http.post("/bdp/cboard/admin/deleteUserRole", {
            userIdArr: angular.toJson(userIds),
            roleIdArr: angular.toJson(roleIds)
        }).success(function (serviceStatus) {
            if (serviceStatus == '1') {
    ...
    $scope.grantRes = function () {
        ...
        $http.post("/bdp/cboard/admin/updateRoleRes", {
            roleIdArr: angular.toJson(roleIds),
    ...
    $scope.deleteRole = function () {
        ModalUtils.confirm(translate("COMMON.CONFIRM_DELETE"), "modal-info", "lg", function () {
            $http.post("/bdp/cboard/admin/deleteRole", {
    ...
    $scope.deleteUser = function () {
        ModalUtils.confirm(translate("COMMON.CONFIRM_DELETE"), "modal-info", "lg", function () {
            $http.post("/bdp/cboard/admin/deleteUser", {
