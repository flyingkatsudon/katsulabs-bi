...
cBoard.controller('shareResCtrl', function ($scope, $http, ModalUtils, $filter) {
    ...
    var getRoleList = function () {
        $http.get("/bdp/cboard/admin/getRoleListAll").success(function (response) {
    ...
    var getBoardList = function () {
        return $http.get("/bdp/cboard/admin/getBoardListUser").success(function (response) {
    ...
    var getDatasetList = function () {
        return $http.get("/bdp/cboard/admin/getDatasetListUser").success(function (response) {
    ...
    var getWidgetList = function () {
        return $http.get("/bdp/cboard/admin/getWidgetListUser").success(function (response) {
    ...
    $scope.grantRes = function () {
        ...
        $http.post("/bdp/cboard/admin/updateRoleResUser", {
