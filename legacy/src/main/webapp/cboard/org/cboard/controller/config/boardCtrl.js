...
cBoard.controller('boardCtrl',
    ...
    var originalData = [];
    var updateUrl = "/bdp/cboard/dashboard/updateBoard";

    var getBoardList = function () {
        return $http.get("/bdp/cboard/dashboard/getBoardList").success(function (response) {
    ...
    var getDatasetList = function () {
        $http.get("/bdp/cboard/dashboard/getDatasetList")
            .then(function (response) {
                $scope.datasetList = response.data;
                return $http.get("/bdp/cboard/dashboard/getWidgetList");
            })
            .then(function (response) {
    ...
    $scope.copyBoard = function (board) {
        ...
        o.name = o.name + '_copy';
        $http.post("/bdp/cboard/dashboard/saveNewBoard", {json: angular.toJson(o)}).success(saveBoardCallBack);
    };

    $scope.deleteBoard = function (board) {
        ModalUtils.confirm(translate("COMMON.CONFIRM_DELETE"), "modal-warning", "lg", function () {
            $http.post("/bdp/cboard/dashboard/deleteBoard", {id: board.id}).success(function (serviceStatus) {
    ...
    $scope.saveBoard = function (notify) {
        ...
        if ($scope.optFlag == 'new') {
            return $http.post("/bdp/cboard/dashboard/saveNewBoard", {json: angular.toJson($scope.curBoard)}).success(callBack);
    ...
    $scope.changeSourceCol = function (e, widgetId) {
        ...
        $http.get("/bdp/cboard/dashboard/dashboardWidget?id=" + e.widgetId).then(function (response) {
            if (!response) {
                return false;
            }
