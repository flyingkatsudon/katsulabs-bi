 ...
 */
var CBoardGoogleMapRender = function (jqContainer, options) {
    this.container = jqContainer; // jquery object
    this.options = options;
};

CBoardGoogleMapRender.prototype.html = function (persist) {
    var self = this;
...
CBoardGoogleMapRender.prototype.realTimeTicket = function () {
    var self = this;
    return function (o) {
...
CBoardGoogleMapRender.prototype.do = function () {
    var self = this;
    $(self.container).html(self.rendered());
};

CBoardGoogleMapRender.prototype.template = "<div id='googleMap' style='width:1169.33px;height:450px;'></div>";
