...
cBoard.controller('widgetCtrl', function ($scope, $state, $stateParams, $http, $uibModal, dataService, ModalUtils, updateService, $filter, chartService, $timeout) {
        ...
        var updateUrl = "/bdp/cboard/dashboard/updateWidget";
        ...
        $scope.chart_types = [
            ...
            //FROM HERE, additional widgets
            {
        		name: 'googleMap', value: 'googleMap', class: 'cGoogleMap',
            	row: 'row',
            	column: 'column',
            	measure: 'measure'
        	},
        	{
        		name: 'wordBubble', value: 'wordBubble', class: 'cWordBubble',
            	row: 'row',
            	column: 'column',
            	measure: 'measure'
        	},
            {
                name: 'fusionganttcharts', value: 'fusionganttcharts', class: 'cFusionganttcharts',
                row: '1 or more',
                column: '0 or more',
                measure: '1 or more'
            },
            {
                name: 'Boxplot', value: 'boxplot', class: 'cBoxplot',
                row: '1 or more',
                column: '0 or more',
                measure: '1 or more'
            },
            {
                name: 'Theme River (Stream Graph)', value: 'themeRiver', class: 'cThemeRiver',
                row: '1 or more',
                column: '0 or more',
                measure: '1 or more'
            },
            {
                name: 'Sunburst', value: 'sunburst', class: 'cSunburst',
                row: '1 or more',
                column: '0 or more',
                measure: '1 or more'
            },
            {
                name: 'Parallel', value: 'parallel', class: 'cParallel',
                row: '1 or more',
                column: '0 or more',
                measure: '1 or more'
            },
            {
                name: 'Pyramid', value: 'pyramid', class: 'cPyramid',
                row: '1 or more',
                column: '0 or more',
                measure: '1 or more'
            },
            {
                name: 'Pareto', value: 'pareto', class: 'cPareto',
                row: '1 or more',
                column: '0 or more',
                measure: '1 or more'
            }
        ...
        $scope.chart_types_status = {
            ...
            //FROM Here, additional widgets
            "wordBubble":true, "googleMap":true, 'fusionganttcharts': true, "boxplot": true, "themeRiver": true, 
            "sunburst": true, "parallel": true, "pyramid": true, "pareto": true
        };
        ...
        $scope.configRule = {
            ...
            //FROM HERE, additional widgets
            googleMap: {keys: 2, groups: -1, filters: -1, values: 2},
            wordBubble: {keys: 1, groups: 0, filters: -1, values: 1},
        	fusioncharts: {keys: 2, groups: -1, filters: -1, values: 2},
    	    boxplot: {keys: 2, groups: -1, filters: -1, values: 2},
    	    themeRiver: {keys: 2, groups: -1, filters: -1, values: 2},
    	    sunburst: {keys: 2, groups: -1, filters: -1, values: 2},
    	    parallel: {keys: 2, groups: -1, filters: -1, values: 2},
    	    pyramid: {keys: 2, groups: -1, filters: -1, values: 2},
    	    pareto: {keys: 2, groups: -1, filters: -1, values: 2} 
        };
        ...
        var loadDataset = function (callback) {
            $http.get("/bdp/cboard/dashboard/getDatasetList").success(function (response) {
        ...
        $http.get("/bdp/cboard/dashboard/getDatasourceList").success(function (response) {
        ...
        var getWidgetList = function (callback) {
            $http.get("/bdp/cboard/dashboard/getWidgetList").success(function (response) {
        ...
        var getCategoryList = function () {
            $http.get("/bdp/cboard/dashboard/getWidgetCategoryList").success(function (response) {
...
// };
        ...
        $scope.saveWgt = function () {
            ...
            if ($scope.optFlag == 'new') {
                $http.post("/bdp/cboard/dashboard/saveNewWidget", {json: angular.toJson(o)}).success(function (serviceStatus) {
                    if (serviceStatus.status == '1') {
                        getWidgetList();
                        getCategoryList();
                        ModalUtils.alert(translate("COMMON.SUCCESS"), "modal-success", "sm");
        ...
        $scope.editWgt = function (widget) {
            $http.post("/bdp/cboard/dashboard/checkWidget", {id: widget.id}).success(function (response) {
        ...
        $scope.deleteWgt = function (widget) {
            ModalUtils.confirm(translate("COMMON.CONFIRM_DELETE"), "modal-info", "lg", function () {
                $http.post("/bdp/cboard/dashboard/deleteWidget", {id: widget.id}).success(function (serviceStatus) {
                    if (serviceStatus.status == '1') {
                        getWidgetList();
                    } else {
                        ModalUtils.alert(serviceStatus.msg, "modal-warning", "lg");
        ...
        $scope.getQueryView = function () {
            if ($scope.datasource && $scope.datasource.name) {
                return '/bdp/cboard/dashboard/getConfigView?type=' + $scope.datasource.type;
            }
        };
        ...
        $scope.doConfigParams = function () {
            $http.get('/bdp/cboard/dashboard/getConfigParams', {
                params: {
