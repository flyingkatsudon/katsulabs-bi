...
cBoard.controller('dashboardViewCtrl', function ($timeout, $rootScope, $scope, $state, $stateParams, $http, ModalUtils, chartService, $interval, $uibModal, dataService) {
    ...
    $http.post("/bdp/cboard/admin/isConfig", {type: 'widget'}).success(function (response) {
    ...
    $scope.export = function () {
        ...
        $http({
            url: "/bdp/cboard/dashboard/exportBoard?id=" + $stateParams.id,
            method: "POST",
            headers: {
    ...
    $scope.load = function (reload) {
        ...
        $http.get("/bdp/cboard/dashboard/getBoardData?id=" + $stateParams.id).success(function (response) {
            $scope.intervalGroup = {};
            $scope.loading = false;
    ...
    $http.get("/bdp/cboard/dashboard/getBoardParam?boardId=" + $stateParams.id).success(function (response) {
        if (response) {
    ...
    $scope.newBoardParam = function (name) {
        ...
        $http.post("/bdp/cboard/dashboard/saveBoardParam", {
