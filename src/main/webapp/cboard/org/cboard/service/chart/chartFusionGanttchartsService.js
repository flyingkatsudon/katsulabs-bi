 ...
 */
'use strict';
cBoard.service('chartFusionGanttchartsService', function (dataService, $compile, $filter) {

    var translate = $filter('translate');

    this.render = function (containerDom, option, scope, persist, data) {
        var render = new CBoardFusionchartsRender(containerDom, option); //이부분 갔다오면, 프리뷰에 차트 그리기 사전작업 하는 것임, containerDom에는 div#Preview/선택자 #preview, option에는 kpi옵션들: value, style, edit, refresh값이 들어가 있다.
